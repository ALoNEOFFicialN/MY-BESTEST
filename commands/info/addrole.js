...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (!message.guild.me.permissions.has("MANAGE_ROLES")) return message.channel.send("<:recluse8:827723422074535936> *I Dont Have The Permissions To Add Roles To Users! - [MANAGE_ROLES]*> ");
